...
the empirical results are observed.
Since hypotheses are examined across multiple outcomes, the analysis also accounts for multiple testing. For the main 
hypothesis tests, \(p\)-values are adjusted using the Holm procedure within the respective pre-specified hypothesis 
families, while unadjusted estimates and 95\% confidence intervals are reported alongside the adjusted inference. 
